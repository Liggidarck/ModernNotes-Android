...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(theme_app.equals("Orange")) {
            ...
            goToPro.setBackground(ContextCompat.getDrawable(this, R.drawable.top_note_background_orange));
        }
        ...
        if(theme_app.equals("Blue")) {
            ...
            goToPro.setBackground(ContextCompat.getDrawable(this, R.drawable.top_note_back_blue));
        }
        ...
        if(theme_app.equals("Green")) {
            ...
            goToPro.setBackground(ContextCompat.getDrawable(this, R.drawable.top_note_back_green));
        }
        ...
        if(theme_app.equals("Red")) {
            ...
            goToPro.setBackground(ContextCompat.getDrawable(this, R.drawable.top_note_back_red));
        }
        ...
        if(theme_app.equals("Fiolet")) {
            ...
            goToPro.setBackground(ContextCompat.getDrawable(this, R.drawable.top_note_back_fiolet));
        }
